...
bool testPathTracerReservoirGiMeasurementContract()
{
	...
	const CounterOffsetExpectation counterOffsets[] = {
	    {"reservoirGiTargetWeightScaledSum",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiTargetWeightScaledSum), 96u},
	    {"reservoirGiSelectedLocal",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiSelectedLocal), 100u},
	    {"reservoirGiSelectedTemporal",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiSelectedTemporal), 104u},
	    {"reservoirGiSelectedSpatial",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiSelectedSpatial), 108u},
	    {"reservoirGiConfidenceMScaledSum",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiConfidenceMScaledSum), 112u},
	    {"reservoirGiLocalSurfaceHits",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalSurfaceHits), 116u},
	    {"reservoirGiLocalValidSamples",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalValidSamples), 120u},
	    {"reservoirGiLocalMissCandidates",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalMissCandidates), 124u},
	    {"reservoirGiLocalMissPositiveWeight",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalMissPositiveWeight), 128u},
	    {"reservoirGiLocalSurfaceInvalid",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalSurfaceInvalid), 132u},
	    {"reservoirGiAcceptedLocalSurface",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiAcceptedLocalSurface), 136u},
	    {"reservoirGiAcceptedLocalMiss",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiAcceptedLocalMiss), 140u},
	    {"reservoirGiLocalShadowRays",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalShadowRays), 144u},
	    {"reservoirGiTemporalReconnectRays",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiTemporalReconnectRays), 148u},
	    {"reservoirGiTemporalShadowRays",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiTemporalShadowRays), 152u},
	    {"reservoirGiHistoryGuideUsed",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiHistoryGuideUsed), 156u},
	    {"reservoirGiHistoryGuideRejectedLowWeight",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiHistoryGuideRejectedLowWeight), 160u},
	    {"reservoirGiHistoryGuideFallbackCosine",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiHistoryGuideFallbackCosine), 164u},
	    {"reservoirGiHistoryGuideRejectReprojection",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiHistoryGuideRejectReprojection), 168u},
	    {"reservoirGiHistoryGuideRejectLoad",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiHistoryGuideRejectLoad), 172u},
	    {"reservoirGiHistoryGuideRejectGeometry",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiHistoryGuideRejectGeometry), 176u},
	    {"reservoirGiHistoryGuideNeighborSearches",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiHistoryGuideNeighborSearches), 180u},
	    {"reservoirGiHistoryGuideNeighborHits",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiHistoryGuideNeighborHits), 184u},
	    {"reservoirGiHistoryGuideNeighborMisses",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiHistoryGuideNeighborMisses), 188u},
	    {"reservoirGiLocalRejectGeometry",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalRejectGeometry), 192u},
	    {"reservoirGiLocalRejectNoLight",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalRejectNoLight), 196u},
	    {"reservoirGiLocalRejectZeroTarget",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalRejectZeroTarget), 200u},
	    {"reservoirGiLocalRejectBadPdf",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiLocalRejectBadPdf), 204u},
	    {"reservoirGiReceiverCacheStore",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheStore), 208u},
	    {"reservoirGiReceiverCacheAttempt",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheAttempt), 212u},
	    {"reservoirGiReceiverCacheHit",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheHit), 216u},
	    {"reservoirGiReceiverCacheMiss",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheMiss), 220u},
	    {"reservoirGiReceiverCacheRejectNoLight",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheRejectNoLight), 224u},
	    {"reservoirGiReceiverCacheAccepted",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheAccepted), 228u},
	    {"reservoirGiSelectedCache",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiSelectedCache), 232u},
	    {"reservoirGiReceiverReconnectAttempt",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverReconnectAttempt), 236u},
	    {"reservoirGiReceiverReconnectHit",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverReconnectHit), 240u},
	    {"reservoirGiReceiverReconnectMiss",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverReconnectMiss), 244u},
	    {"reservoirGiReceiverReconnectRejectVisibility",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverReconnectRejectVisibility), 248u},
	    {"reservoirGiReceiverReconnectRejectTarget",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverReconnectRejectTarget), 252u},
	    {"reservoirGiReceiverReconnectAccepted",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverReconnectAccepted), 256u},
	    {"reservoirGiSelectedCacheReconnect",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiSelectedCacheReconnect), 260u},
	    {"reservoirGiReceiverCacheContinuationAttempt",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheContinuationAttempt), 264u},
	    {"reservoirGiReceiverCacheContinuationHit",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheContinuationHit), 268u},
	    {"reservoirGiReceiverCacheContinuationMiss",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheContinuationMiss), 272u},
	    {"reservoirGiReceiverCacheContinuationAccepted",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiReceiverCacheContinuationAccepted), 276u},
	    {"reservoirGiBrightSurfelStore",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelStore), 280u},
	    {"reservoirGiBrightSurfelAttempt",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelAttempt), 284u},
	    {"reservoirGiBrightSurfelHit",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelHit), 288u},
	    {"reservoirGiBrightSurfelMiss",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelMiss), 292u},
	    {"reservoirGiBrightSurfelRejectVisibility",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelRejectVisibility), 296u},
	    {"reservoirGiBrightSurfelRejectGeometry",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelRejectGeometry), 300u},
	    {"reservoirGiBrightSurfelRejectTarget",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelRejectTarget), 304u},
	    {"reservoirGiBrightSurfelAccepted",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelAccepted), 308u},
	    {"reservoirGiSelectedBrightSurfel",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiSelectedBrightSurfel), 312u},
	    {"reservoirGiBrightSurfelPrecheckRejectTarget",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelPrecheckRejectTarget), 316u},
	    {"reservoirGiBrightSurfelTrainingAttempt",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelTrainingAttempt), 320u},
	    {"reservoirGiBrightSurfelTrainingStore",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelTrainingStore), 324u},
	    {"reservoirGiBrightSurfelTrainingRejectGeometry",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelTrainingRejectGeometry), 328u},
	    {"reservoirGiBrightSurfelTrainingRejectTarget",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelTrainingRejectTarget), 332u},
	    {"reservoirGiBrightSurfelSelectorRejectGeometry",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelSelectorRejectGeometry), 336u},
	    {"reservoirGiBrightSurfelSelectorRejectTarget",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelSelectorRejectTarget), 340u},
	    {"reservoirGiBrightSurfelSelectorViable",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelSelectorViable), 344u},
	    {"reservoirGiBrightSurfelIndexedQuery",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelIndexedQuery), 348u},
	    {"reservoirGiBrightSurfelIndexedEmpty",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelIndexedEmpty), 352u},
	    {"reservoirGiBrightSurfelIndexedProbe",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelIndexedProbe), 356u},
	    {"reservoirGiBrightSurfelSelectorRejectDistance",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelSelectorRejectDistance), 360u},
	    {"reservoirGiBrightSurfelSelectorRejectReceiverHemisphere",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelSelectorRejectReceiverHemisphere), 364u},
	    {"reservoirGiBrightSurfelSelectorRejectSurfelHemisphere",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelSelectorRejectSurfelHemisphere), 368u},
	    {"reservoirGiBrightSurfelSelectorRejectInvalidVector",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiBrightSurfelSelectorRejectInvalidVector), 372u},
	    {"reservoirGiAuditCurrentLumaScaledSum",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiAuditCurrentLumaScaledSum), 376u},
	    {"reservoirGiAuditReferenceLumaScaledSum",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiAuditReferenceLumaScaledSum), 380u},
	    {"reservoirGiAuditRelativeErrorScaledSum",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiAuditRelativeErrorScaledSum), 384u},
	    {"reservoirGiAuditProbeScaleScaledSum",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiAuditProbeScaleScaledSum), 388u},
	    {"reservoirGiAuditSampleCount",
	     offsetof(Laphria::PathTracerAnalysisCounters, reservoirGiAuditSampleCount), 392u}};
	...
	const std::string removedFirstHitMetricSymbols[] = {
	    std::string("firstHitProbe") + "Count",
	    std::string("firstHitProbe") + "SurfaceHitCount",
	    std::string("firstHitProbe") + "SunVisibleCount",
	    std::string("firstHitProbe") + "ContributionSum",
	    std::string("firstHitProbe") + "SunVisibleContributionSum",
	    std::string("firstHitProbe") + "SurfaceHitRatio",
	    std::string("firstHitProbe") + "SunVisibleRatio",
	    std::string("firstHitProbe") + "ContributionAverage",
	    std::string("firstHitProbe") + "SunVisibleContributionAverage",
	    std::string("recordFirstHit") + "ProbeStats"};
	for (const std::string &symbol : removedFirstHitMetricSymbols)
	{
		if (containsText(uiHeader, symbol.c_str()) ||
		    containsText(uiSource, symbol.c_str()) ||
		    containsText(engineAuxiliaryHeader, symbol.c_str()) ||
		    containsText(engineHeader, symbol.c_str()) ||
		    containsText(engineCore, symbol.c_str()) ||
		    containsText(raygen, symbol.c_str()))
		{
			std::cerr << "removed first-hit probe metric symbol is still present: " << symbol << "\n";
			return false;
		}
	}

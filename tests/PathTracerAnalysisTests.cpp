...
bool testPathTracerDebugAovContract()
{
    ...
    const char *requiredLabels[] = {
        ...
        "Targeted Diagnostic Refresh",
        "Cache Visibility Budget",
        "Cache Proposal Mode",
        "Cache Weighting",
        "Cache MIS Strength",
        "Calibrated Weight",
    ...
    const char *requiredShaderSymbols[] = {
        ...
        "CACHED_REUSE_MAX_RADIUS_CELLS",
        "cacheRadiusCellCount",
        ...
        "selectGlobalCachedSunVisibleCandidate",
        ...
        "recordSunVisibleConnectionCandidate",
        "selectCachedSunVisibleConnection",
        "selectedConnectionProposal",
        "frameId + SUN_VISIBLE_CONNECTION_CACHE_FRAME_SLOT_COUNT == currentFrame",
        "refreshSunVisibleCandidateCache",
        "refreshDiagnosticTargetSunVisibleCandidateCache",
        "TARGETED_DIAGNOSTIC_CACHE_REFRESH_BIT",
        ...
        "bestDistanceSq",
        "CACHED_REUSE_DEFAULT_CONNECTION_DISTANCE",
        "cacheConnectionRadius * cacheConnectionRadius",
        "CACHE_WEIGHTING_CALIBRATED",
        "CACHE_WEIGHTING_MIS_APPROX",
        "CACHE_PROPOSAL_SPATIAL_LOCAL",
        "CACHE_PROPOSAL_GLOBAL_NON_LOCAL",
        "cacheProposalMode = int(packedPathTracerMaterialIndex & 0xFFu)",
        "cacheMaxRecordAgeFrames = max(packedPathTracerMaterialIndex >> 8, 1u)",
        "computeCachedReuseMisWeight",
        "computeConservativeCachedReuseMisWeight",
        "cacheMisStrength",
        "CACHED_REUSE_MAX_RECORD_AGE_FRAMES",
        "CACHE_VISIBILITY_BUDGET_SHIFT",
        "cacheVisibilityBudgetCode",
    ...
    const char *requiredEngineSymbols[] = {
        ...
        "cacheReuseExtraSampleZeroCount",
        "cacheReuseUnavailableCandidateCount",
        "cacheReuseSelectedCount",
        "cacheReuseSelectMissCount",
        "cacheReuseRejectDistanceCount",
        "cacheReuseRejectGeometryCount",
        "cacheReuseRejectVisibilityCount",
        "cacheReuseSelectLoadSuccessCount",
        "cacheReuseSelectLoadMissCount",
        "cacheReuseSelectRejectDistanceCount",
        "cacheReuseSelectRejectGeometryCount",
        "cacheReuseAcceptedDistanceNearCount",
        "cacheReuseAcceptedDistanceMidCount",
        "cacheReuseAcceptedDistanceFarCount",
        "cacheReuseAcceptedDistanceVeryFarCount",
        "cacheReuseAcceptedLumaDarkCount",
        "cacheReuseAcceptedLumaDimCount",
        "cacheReuseAcceptedLumaUsefulCount",
        "cacheReuseAcceptedLumaBrightCount",
        "cacheConnectionReuseAttempts",
        "cacheConnectionReuseAccepted",
        "cacheReadBank",
        "cacheWriteBank",
        "cacheReadBankInsertCount",
        "cacheWriteBankInsertCount",
        "cacheReadBankResidentCandidateCount",
        "cacheWriteBankResidentCandidateCount",
        ...
        "cacheVisibilityValidationBudget",
        "targetedDiagnosticCacheRefresh",
        "cacheMisStrength",
        ...
        "Hard / Cached Reuse Chosen",
        "Medium / Candidate RIS Reference",
        "Medium / Cached Reuse Chosen",
        "Easy / Candidate RIS Reference",
        "Easy / Cached Reuse Chosen",
        "Sponza / No First-Hit GI",
        "Sponza / Chosen Radius 14 Budget 1",
        "Sponza / Global Non-Local Radius 14 Budget 1",
        "Sponza / Connection Cache Radius 14 Budget 1",
        "Sponza / Cached Reuse Samples 2",
        "Sponza / Cached Reuse Trials 1",
        "Sponza / Cached Reuse Trials 4",
        "Sponza / Cached Reuse Trials 8",
        "Sponza / Cached Reuse No Refresh",
        "Sponza / Radius 3.5",
        "Sponza / Radius 7.0",
        "Sponza / Radius 14.0",
        "Sponza / Radius 28.0",
        "Sponza / Radius 14 Budget 1",
        "Sponza / Radius 14 Budget 2",
        "Sponza / Radius 14 Budget 4",
        "noRefreshRow.clearCacheBeforeRow = false",
        "cacheConnectionRadius = row.cacheConnectionRadius",
        "cacheVisibilityValidationBudget = row.cacheVisibilityValidationBudget",
        "connectionRadius=%.2f",
        "visibilityBudget=%d",
        "proposalMode=%d",
        "uint32_t padding3",
        ...
        "blackEnvironment = row.blackEnvironment",
        "applyDebugLightPreset = row.applyDebugLightPreset",
        ...
        "cacheReusePathEntries=",
        "cacheReuseExtraSampleZero=",
        "cacheReuseUnavailable=",
        "cacheReuseAttempts=",
        "cacheReuseSelected=",
        "cacheReuseSelectMiss=",
        "cacheReuseRejectDistance=",
        "cacheReuseRejectGeometry=",
        "cacheReuseRejectVisibility=",
        "cacheReuseSelectLoaded=",
        "cacheReuseSelectLoadMiss=",
        "cacheReuseSelectRejectDistance=",
        "cacheReuseSelectRejectGeometry=",
        "cacheReuseAcceptedDistanceBuckets=",
        "cacheReuseAcceptedLumaBuckets=",
        "Cache Accepted Distance Buckets",
        "Cache Accepted Luma Buckets",
        "readBank=",
        "readBankInserts=",
        "writeBankInserts=",
        "readBankResidents=",
